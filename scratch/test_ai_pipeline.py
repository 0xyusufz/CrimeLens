"""End-to-end verification of Groq Extraction + Gemini Intelligence."""
...
# Mock session or test prompt directly with gemini engine
if gemini_engine.is_available():
    ...
    resp = gemini_engine.client.models.generate_content(
        model=gemini_engine.model,
        contents=prompt,
    )
    print("Gemini Response:\n", resp.text.strip())
    print("\n✅ AI Pipeline integration test passed successfully!")
else:
